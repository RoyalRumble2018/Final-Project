...
dag = DAG('adsec2', default_args=default_args,schedule_interval='*/150 0 * * *')
...
t6 = BashOperator(
    task_id='part5',
    bash_command='sudo docker cp /home/ec2-user/airflow/dags/Models/. 3f556d329981:/usr/local/src/assg/Models/',
    dag=dag)
